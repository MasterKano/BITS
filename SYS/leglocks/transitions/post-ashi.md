...
## 1. Purpose
Post Ashi is a **reaction hub** used when the defender posts hands/feet, stands, or drives forward in ways that would otherwise:
- strip your knee-line control,
...
## 4. Core Priorities (Non-Negotiables)
1) **Knee line first**
   - If the knee starts to clear, Post Ashi becomes a retention/recapture problem, not a finishing moment.
2) **Hip-to-hip distance**
   - Post Ashi fails when you allow long distance and try to hold with hands.
...
If any answer is “yes,” fix structure or transition—do not escalate.
...
### 9.1 Post Ashi → Outside Ashi (default upgrade)
Use when you stabilise the post and can rotate into Outside for stronger hip control and back-safety.

### 9.2 Post Ashi → Cross/Inside Ashi (if defender turns)
...
- If you separate legs and come up: `../../top/camping.md` (default stabilizer)
- If forward step + cranial pin is available: `../../top/north-south.md`
- If hips are available to clamp: `../../top/body-lock.md`
- If turtle/quadpod forms: `../../top/tight-waist.md`
- If they are rotating and you must follow connection: `../../top/cross-body-ride.md`

### 9.6 Post Ashi → Exit (guard/stand)
If:
- knee line is clearly lost, or
- you are being squared/passed, or
...
**Top outcomes (cross-domain canon links)**
- `../../top/camping.md`
- `../../top/north-south.md`
- `../../top/body-lock.md`
- `../../top/tight-waist.md`
...
- My cleanest top outcome (camping / north-south / body lock):
