...
### 9.5 Post Ashi → Exit (guard/stand)
If:
...
- `irimi-ashi-garami.md` (common source)
- `butterfly-ashi.md` (pressure/angle connector)
- `outside-ashi-garami.md` (default stable hub)
- `straight-ankle-achilles.md` (tether tool)
- `far-hip-ashi.md` (safety resolution)
